...
def parser(text):
    ...
    prompt = (
        ...
        "Education entries should include: institution, degree (associates, bachelors, masters, etc), major, minor, graduationDate, and gpa. "
        "For the degree, only return the degree level (bachelors, associates, masters, doctorate) do not include degree area. "
